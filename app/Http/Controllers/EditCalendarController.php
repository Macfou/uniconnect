...
{
      public function editcalendarPage(Request $request)
    {
        ...
        return view('pages.editcalendar', compact('facilities', 'selectedYear', 'selectedMonth', 'selectedDate', 'bookedSlots'));
    }

    public function editgetBookedSlots(Request $request)
{
