...
public function pendingRequests()
{
    ...
    return view('spmo.spmo_pages.spmo_pending', compact('pendingRequests'));
}
...
public function approve($id)
{
    ...
    return redirect()->route('spmo.spmo_pages.spmo_approved')->with('success', 'Borrow request approved.');
}

public function approvedRequests()
{
    $approvedRequests = BorrowRequest::where('status', 'approved')->with('user', 'equipment', 'listing')->get();
    return view('spmo/spmo_pages/spmo_approved', compact('approvedRequests'));
}
...
public function markAsBorrowed($id)
{
    ...
    return redirect()->route('spmo.spmo_borrowed')->with('success', 'Equipment marked as borrowed.');
}
