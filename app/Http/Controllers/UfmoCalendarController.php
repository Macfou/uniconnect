...
class UfmoCalendarController extends Controller
{
    public function ufmocalendar(Request $request)
    {
        ...
        return view('ufmo.ufmo_pages.ufmo_calendar', compact('facilities', 'selectedYear', 'selectedMonth', 'selectedDate', 'bookedSlots'));
    }
