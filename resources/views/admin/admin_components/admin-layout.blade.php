...
<body>
    <div class="min-h-screen bg-gray-50/50">
      <aside class="bg-gradient-to-br from-gray-800 to-gray-900 fixed inset-y-0 left-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl xl:translate-x-0 flex flex-col">
        <div class="relative border-b border-white/20 p-4">
          <a class="flex items-center gap-4" href="#/">
            <h6 class="text-white text-base font-semibold">Welcome</h6>
          </a>
          <button class="absolute right-4 top-4 text-white hover:bg-white/10 active:bg-white/30 xl:hidden w-8 h-8 flex items-center justify-center rounded-lg" type="button">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="h-5 w-5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"></path>
            </svg>
          </button>
        </div>
        <div class="flex-1 overflow-y-auto max-h-screen px-4">
          <ul class="space-y-2">
              <li>
                <a aria-current="page" class="active" href="/admin/admin_pages/admin_index">
              ...
              <li>
                <a class="" href="/admin/admin_pages/organization">
                  <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                    ...
                    <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">Organizations</p>
                  </button>
                </a>
              </li>
              ...
              <li>
                <a class="" href="/admin/admin_pages/section">
                  <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                    ...
                    <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">Section</p>
                  </button>
                </a>
              </li>
              <li>
            ...
            <ul class="mb-4 flex flex-col gap-1">
              ...
              <li>
                <a class="" href="/admin/admin_users/admin_profile">
                  <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5 h-5 text-inherit">
              ...
              <li>
                <a class="" href="/admin/admin_users/admin_adduser">
                  <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5 h-5 text-inherit">
                      <path d="M6.25 6.375a4.125 4.125 0 118.25 0 4.125 4.125 0 01-8.25 0zM3.25 19.125a7.125 7.125 0 0114.25 0v.003l-.001.119a.75.75 0 01-.363.63 13.067 13.067 0 01-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 01-.364-.63l-.001-.122zM19.75 7.5a.75.75 0 00-1.5 0v2.25H16a.75.75 0 000 1.5h2.25v2.25a.75.75 0 001.5 0v-2.25H22a.75.75 0 000-1.5h-2.25V7.5z"></path>
                    </svg>
                    <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">Admin Users</p>
                  </button>
                </a>
              </li>
              <li>
              ...
              <div class="flex items-center">
                <div class="mr-auto md:mr-4 md:w-56">
                  ...
                  <p id="account-btn" class="block py-2 px-3 text-black rounded hover:underline  cursor-pointer">
                   <i class="fa-solid fa-user pr-4"></i>{{ucfirst(auth()->user()->name)}}
               </p>
                  @endauth
                </a>
