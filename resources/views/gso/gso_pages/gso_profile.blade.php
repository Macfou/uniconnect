<x-gso-layout>
    ...
    <div class="max-w-lg mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <!-- Display GSO User Information -->
        <p class="text-gray-700"><strong>First Name:</strong> {{ $gsoUser->fname }} {{ $gsoUser->lname }}</p>
        <p class="text-gray-700"><strong>Email: </strong> {{ $gsoUser->email }}</p>
        ...
        <form action="{{ route('gso.updatePassword') }}" method="POST" class="mt-4">
            @csrf
            <div class="mb-4">
