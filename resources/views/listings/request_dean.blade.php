    ...
    <div class="pt-28 pb-32 px-6 max-w-3xl mx-auto">
        ...
        <div class="bg-white shadow-lg rounded-lg p-8">
            <h2 class="text-xl font-semibold text-gray-800 mb-6">
                Upload letter Dean Approval PDF for: <span class="text-blue-600">{{ $event->tags ?? 'Untitled Event' }}</span>
            </h2>
...
@endif
            ...
            {{-- Upload Form --}}
            <form action="{{ route('dean.approval.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
