<x-layout>
    ...
    <div id="modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        ...
        <div id="timeSlots" class="grid grid-cols-4 gap-2 mt-4">
            ...
            <div class="mt-4 flex justify-end space-x-2">
                ...
                <a id="saveProceedBtn" href="#" onclick="redirectToEdit($listing)"
    ...
    <script>
        ...
        function redirectToEdit($listing) {
    ...
    let url = `/listings/${listing}/edit?date=${encodeURIComponent(date)}&classification=${encodeURIComponent(classification)}&facility=${encodeURIComponent(facility)}&time=${encodeURIComponent(time)}`;
