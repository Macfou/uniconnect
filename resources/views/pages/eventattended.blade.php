...
<div id="reviewModal{{ $attendance->event->id }}" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
...
document.querySelectorAll('[id^="submitFeedback"]').forEach(submitFeedback => {
  submitFeedback.addEventListener('click', () => {
    ...
    const feedback = document.getElementById(`feedbackText${eventId}`).value; // Get feedback text
    ...
    fetch('/feedback', {
      ...
      body: JSON.stringify({ event_id: eventId, feedback: feedback })
    })
