...
<div class="max-w-2xl mx-auto fixed   left-0 p-4 bg-white rounded shadow-lg">
	...
	<aside class="w-64" aria-label="Sidebar">
			...
			<ul class="space-y-2">
				<li>
					<a href="/pages/students"
						...
						<span class="ml-3 font-bold text-laravel">Students</span>
					</a>
				</li>
				<li>
					<a href="/student_attendance"
						...
						<span class="ml-3 font-bold text-laravel">Students Attendance</span>
					</a>
				</li>
        ...
        d="M10 12a1 1 0 01.874.514l2 4a1 1 0 11-1.748.972l-.626-1.252H8.5l-.626 1.252a1 1 0 01-1.748-.972l2-4A1 1 0 0110 12z" />
						...
						<span class="flex-1 ml-3 whitespace-nowrap text-laravel font-bold">Events Requests</span>
