        ...
        <div class="max-w-screen-xl mx-auto mb-12 lg:mb-16  ">
          <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
              {{ auth()->check() ? strtoupper(auth()->user()->org) : 'Uniconnect' }}
          </span>
        ...
        <div class="max-w-screen-xl mx-auto ">
          <div class="grid grid-cols-8 md:grid-cols-9  lg:grid-cols-8  divide-gray-200 divide-y-2 md:divide-x-2 md:divide-y-0 md:-mx-8">
            <div class="col-span-8 md:col-span-3 lg:col-span-2 md:px-8 py-4 md:py-0">
              <h5 class="text-xl font-semibold text-gray-700">Uniconnect</h5>
              <nav class="mt-4">
                <ul class="space-y-2">
                  <li>  
            ...
            <div class="col-span-8 md:col-span-3 lg:col-span-3 md:px-8 py-4 md:py-0">
              <h5 class="text-xl font-semibold text-gray-700">My Account</h5>
              <nav class="mt-4">
                <ul class="grid lg:grid-cols-2">
                  <li class="mb-2">
                    <a href="#" class="font-normal text-base hover:text-gray-400"><i class="fa-solid fa-user pr-4"></i>Welcome {{ auth()->check() ? ucfirst(auth()->user()->fname) : 'Herons' }}</a>
                  </li>
                  <li class="mb-2">
                    <a href="#" class="font-normal text-base hover:text-gray-400"><i class="fa-solid fa-gear pr-4"></i>Manage Account</a>
                  </li>
                  <li class="mb-2">
                    <a href="#" class="font-normal text-base hover:text-gray-400"><i class="fa-solid fa-envelope pr-4"></i>{{ auth()->check() ? ucfirst(auth()->user()->email) : 'uniconnect@gmail.com' }}</a>
                  </li>
                  <li class="mb-2">
                  ...
                  @auth
                  <a href="/login" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="font-normal text-base hover:text-gray-400">
