<x-ufmo-layout>
    ...
    <div class="max-w-lg mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <!-- Display ufmo User Information -->
        <p class="text-gray-700"><strong>First Name:</strong> {{ $ufmoUser->fname }} {{ $ufmoUser->lname }}</p>
        <p class="text-gray-700"><strong>Email: </strong> {{ $ufmoUser->email }}</p>
        ...
        <form action="{{ route('ufmo.updatePassword') }}" method="POST" class="mt-4">
            @csrf
            <div class="mb-4">
